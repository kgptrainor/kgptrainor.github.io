---
layout: post
title:  "Azure Static WebApp - EasyAuth"
...
&nbsp;
![](/img/Azure-Static-WebApp/azure-static-web-apps-overview.png)
&nbsp;
...
&nbsp;
![](/img/Azure-Static-WebApp/Azure-appreg.png)
&nbsp;
&nbsp;

Retrive the Secrets from the keyvault  

![](/img/Azure-Static-WebApp/Azure-Static-kvault.png)

Update the Static WebApp Application settings :

![](/img/Azure-Static-WebApp/azure-staticapp-config.png)
&nbsp;  
...
&nbsp;
![](/img/Azure-Static-WebApp/deploymenttoken.png)
&nbsp;

Azure Static App URL name  

![](/img/Azure-Static-WebApp/appurl.png)
...
&nbsp;
![](/img/Azure-Static-WebApp/githubactions.png)
&nbsp;
...
&nbsp;
![](/img/Azure-Static-WebApp/actions.png)


&nbsp;
![](/img/Azure-Static-WebApp/secrets.png)
...
![](/img/Azure-Static-WebApp/staticappfinal.png)
&nbsp; 
